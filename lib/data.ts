...
export const convictionPicks: ConvictionPick[] = [
  {
    ...
    conviction: 95,
    thesis:
      "The AI infrastructure buildout is still in its early innings. NVIDIA's compute + networking stack remains the default choice for frontier model training and inference at scale, with switching costs and ecosystem lock-in still rising.",
  ...
  },
  {
    ...
    conviction: 88,
    thesis:
      "Post-merger integration friction is fading while deposit market share is rebuilding. A best-in-class franchise trading below its historical premium to the sector is a mispricing that should resolve with improving returns.",
  ...
  },
  {
    ...
    conviction: 82,
    thesis:
      "The sole supplier of EUV lithography sits at the choke point of the entire semiconductor roadmap. Export-control noise has repeatedly created attractive entry points into an irreplaceable franchise.",
...
export const bestCalls: BestCall[] = [
  {
    ...
    thesis:
      "Bought into peak \"Meta is dead\" pessimism during the metaverse spending panic, when the market was pricing in structural decline rather than a temporary cost overshoot. The underlying ad business was stronger and more durable than the market allowed.",
    lesson:
...
export const marketViews: MarketView[] = [
  {
    ...
    date: "Sep 2026",
    commentary:
      "The market is still treating AI infrastructure capex as cyclical when it's structural. Power, networking and advanced packaging remain the binding constraints — not chip supply. We stay focused on the bottlenecks, not the headlines.",
  },
  {
    ...
    date: "Aug 2026",
    commentary:
      "Regional mid-cap banks across India and Southeast Asia are re-rating as credit costs normalize and digital-first cost structures kick in. This is a multi-year re-rating story that Western investors have missed.",
  },
  {
    ...
    date: "Jul 2026",
    commentary:
      "Multi-year budget commitments across the continent have shifted from political rhetoric to signed procurement. Order backlogs at primes are now the clearest visibility investors have had in years.",
  },
];
