    ...
    <section id="top" className="relative overflow-hidden pt-28 sm:pt-36">
      ...
      >
        ...
        >
          <a
            href="#portfolio"
            className="min-h-11 w-full rounded-full bg-gradient-to-r from-violet-500 to-cyan-400 px-8 py-3.5 text-sm font-semibold leading-none text-[#02020a] shadow-[0_10px_40px_-10px_rgba(139,92,246,0.6)] transition-transform hover:scale-[1.01] sm:w-auto"
          >
            View Portfolio
          </a>
          <a
            href="#pitches"
            className="min-h-11 w-full rounded-full border border-white/15 bg-white/5 px-8 py-3.5 text-sm font-semibold leading-none text-white transition-colors hover:bg-white/10 sm:w-auto"
          >
